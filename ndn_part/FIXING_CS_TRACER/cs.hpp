...
#include <boost/signals2/signal.hpp>  // Add this for signals
...
public: // configuration
  ...
  // Define signals for cache events
  boost::signals2::signal<void(const Data&)> cacheHit;       // Fired on cache hit
  boost::signals2::signal<void(const Interest&)> cacheMiss;  // Fired on cache miss
