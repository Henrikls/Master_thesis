...
int main(int argc, char* argv[]) {
    ...
    // Enable tracing
    ndn::CsTracer::InstallAll("cs-trace-scen3-1000cs.txt", Seconds(1));
    ndn::L3RateTracer::InstallAll("rate-trace-scen3-1000cs.txt", Seconds(1));
    ndn::AppDelayTracer::InstallAll("app-delays-scen3-1000cs.txt");
