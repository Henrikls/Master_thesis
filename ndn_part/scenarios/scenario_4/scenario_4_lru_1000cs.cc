...
int main(int argc, char* argv[]) {
    ...
    // Enable tracing
    ndn::CsTracer::InstallAll("cs-trace-scen4-lru-1000cs.txt", Seconds(1));
    ndn::L3RateTracer::InstallAll("rate-trace-scen4-lru-1000cs.txt", Seconds(1));
    ndn::AppDelayTracer::InstallAll("app-delays-trace-scen4-lru-1000cs.txt");
