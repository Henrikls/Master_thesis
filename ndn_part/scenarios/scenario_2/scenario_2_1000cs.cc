...
main(int argc, char* argv[])
{
  ...
  ndn::CsTracer::InstallAll("cs-trace-scen2-1000cs.txt", Seconds(1));
  ndn::L3RateTracer::InstallAll("rate-trace-scen2-1000cs.txt", Seconds(1));
  ndn::AppDelayTracer::InstallAll("app-delays-scen2-1000cs.txt");
